...
<div align="center" data-with-frame="true"><img src="../assets/user-guides/faq_and_trouble_shooting_10.webp" alt="Mining Address List" width="75%"></div>

5. 「Available Unused Addresses」セクションの直下にあるアドレスの USER DATA をダウンロードし、サポートに共有してください。

<div align="center" data-with-frame="true"><img src="../assets/user-guides/faq_and_trouble_shooting_20.webp" alt="FAQ" width="75%"></div>
