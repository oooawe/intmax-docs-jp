...
<div align="center" data-with-frame="true"><img src="../../assets/developers-hub/search-holders.webp" alt="ScrollScan holders" width="75%"></div>

ページ右上の検索アイコンをクリックします。
検索バーに Block Builder の Scroll アドレスを入力します。
以下の画像で赤枠でハイライトされたエリアに、現在の残高が表示されます。

<div align="center" data-with-frame="true"><img src="../../assets/developers-hub/itx-token-balance.webp" alt="ScrollScan ITX balance" width="75%"></div>
